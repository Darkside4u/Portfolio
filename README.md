...
Dynamic Scrollspy: The navigation bar automatically highlights the section you are currently viewing.

Interactive UI Elements: Engaging hover effects on project and skill cards to create a more dynamic user experience.

Clean & Modern Aesthetic: A dark-themed, professional design that puts the content front and center.
...
Bootstrap 5: For the responsive grid system, components, and overall layout.

JavaScript (ES6+): For interactive features like the scrollspy and mobile navigation.

Bootstrap Icons: For clean and scalable icons used throughout the site.
...
git clone https://github.com/Darkside4u/Portfolio.git
